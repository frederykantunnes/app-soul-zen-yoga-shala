...
class DatabaseHelper{
  static final _databaseName = "SZYS.db";
  ...
  static final cidadeColumn = 'cidade';
  static final telefoneColumn = 'telefone';
  static final nascimentoColumn = 'nascimento';
